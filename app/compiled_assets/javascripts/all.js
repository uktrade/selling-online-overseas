...
"use strict";var autoComplete=function(t){function o(){"autocomplete"===t("form#results-form").data("form-type")&&(y.keyup(a),S.keyup(dropdown.manualSelect),C.click(k),y.keypress(function(o){13===o.which&&t(".form-dropdown-option").length>0&&(o.preventDefault(),e())}),t("html").click(function(o){var e=t(o.target);if(!e.hasClass("form-dropdown-input")||""===e.val()){dropdown.closeDropdown();t(".form-dropdown-input").each(function(o,e){var a=t(e);""!==a.val()&&u(a)})}}),w())}function e(){var o=0===t(".form-dropdown-results li.active a").length?t(".form-dropdown-option").first():t(".form-dropdown-results li.active a");i.call(o)}function a(o){var e=t(o.target).next();switch(o.which){case 40:o.preventDefault(),dropdown.selectOption("down",e);break;case 13:o.preventDefault();break;case 27:var a=t(o.target);dropdown.closeDropdown(),u(a);break;default:n(this)}}function n(o){t.ajax({url:t(o).data("url"),type:"GET",dataType:"json",data:{q:t(o).val()}}).done(function(t){var e=t.countries?t.countries:t.categories;e.length>0&&r(e,o)}).fail(function(){}).always(function(){})}function r(o,e){dropdown.closeDropdown();for(var a=t(e).next(),n=0;n<o.length;n++){var r="string"==typeof o[n]?o[n]:"<b>"+o[n][0]+"</b> - "+o[n][1],s="string"==typeof o[n]?o[n]:o[n][0],d=_.contains(I[t(e).data("field")],s)?"form-dropdown-option--selected":"";a.append('<li class="form-dropdown-list" role="option"><a href="" id='+a[0].id+"-"+n+' class="form-dropdown-option '+d+'" data-option-id="'+s+'">'+r+"</li></a></li>")}a.show(),t(".form-dropdown-option").click(i),t(".form-dropdown-list").hover(c),t("html").addClass("overflow--hidden")}function i(o){var e=t(o?o.target:this),a=e.parent().parent().prev(),n=Math.round(Math.random()*+new Date),r=t(this).data("option-id"),i=t(this).parent().parent().prev().data("field");o&&o.preventDefault(),s(r,i)||(p(t(".form-dropdown-tags"),i,r,n),u(a),dropdown.closeDropdown(),l(n,r,i))}function s(o,e){if(_.contains(I[e],o))return d(t('button[data-option-id="'+o+'"]').first().parent()),!0;I[e].push(o)}function d(t){t.addClass("shake-vertical"),setTimeout(function(){t.removeClass("shake-vertical")},1e3)}function c(){t(".form-dropdown-list").removeClass("active"),t(this).hasClass("active")?t(this).removeClass("active"):(t(this).addClass("active"),t(this).children().focus())}function p(o,e,a,n){var r=t("<button>",{"data-button-id":n,"data-option-id":a,"data-item":e,"aria-label":"close "+a+"  tag",html:"x"}),i=t("<li>",{html:a+r[0].outerHTML});t(".autocomplete-status").empty(),i.addClass("operating_countries"===e?"background--light-aqua":"background--stone"),i.attr("aria-label","option"),t(i[0].children).addClass("form-dropdown-tags--close"),t(".autocomplete-status").text(a+" tag added"),o.append(i),t(".form-dropdown-tags--close").on("click",m),h(e,a)}function u(t){dataLayer.push({event:t.attr("id"),search_term:t.val()}),t.val("")}function l(t,o,e){function a(t,o,e){this.buttonId=t,this.option=o,this.section=e}var n=sessionStorage.getItem("tags")?JSON.parse(sessionStorage.getItem("tags")):[];n.push(new a(t,o,e)),sessionStorage.setItem("tags",JSON.stringify(n))}function f(t){var o=_.reject(JSON.parse(sessionStorage.getItem("tags")),function(o){return o.buttonId===t});sessionStorage.setItem("tags",JSON.stringify(o))}function m(o){var e=t(this).data("option-id");o.preventDefault(),t(this).parent().remove(),v(e),f(t(o.target).data("button-id")),g(t(this).data("item"),e)}function g(t,o){I[t]=_.filter(I[t],function(t){return t!==o})}function h(o,e){var a=t("<input>",{type:"checkbox",name:o,value:e,checked:!0,"data-checkbox-id":e});t(".form-dropdown-checkbox").append(a)}function v(o){t('input[data-checkbox-id="'+o+'"]').first().remove()}function w(){sessionStorage.getItem("tags")&&_.each(JSON.parse(sessionStorage.getItem("tags")),function(o){o.section;o.section&&o.option?(p(t(".form-dropdown-tags"),o.section,o.option,o.buttonId),s(o.option,o.section)):f(o.buttonId)})}function b(){sessionStorage.getItem("tags")&&(sessionStorage.removeItem("tags"),t(".form-dropdown-tags").empty(),I={operating_countries:[],product_categories:[]})}function k(o){o.preventDefault(),t(o.target).closest("form")[0].reset(),b(),t(".form-dropdown-option").removeClass("form-dropdown-option--selected"),t(".form-dropdown-checkbox").empty()}var y=t(".form-dropdown .form-dropdown-input"),S=t(".form-dropdown-results"),C=t('a[data-action="clear-fields"]'),I={operating_countries:[],product_categories:[]};return{init:o,selectedEnter:e,inputEvent:a,getResults:n,createDropDown:r,addTag:i,createTag:p,clearInput:u,addTagToStorage:l,deleteTagFromStorage:f,deleteTag:m,addCheckbox:h,deleteCheckbox:v,updateTagsFromStorage:w}}(jQuery);$(document).ready(function(){autoComplete.init()});
