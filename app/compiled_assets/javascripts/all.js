...
"use strict";var sortList=function(){function t(){var t,e=$("#homepage-shortlist-info"),o=$(".markets-list, .markets-grid");e.length&&(t=function(t){t.market_slugs.length&&e.show()}),o.length&&(t=function(t){s(t.market_slugs)}),i(t)}function s(t){t.forEach(function(t){var s=$("[data-slug="+t+"]");r(s,$(s[0].lastChild),"Shortlisted")})}function e(t,s,e){var o=$("<span>",{html:s,class:t});e.append(o),setTimeout(function(){o.remove()},2e3)}function o(t){t.preventDefault();var s=$(t.currentTarget),o=$(s[0].lastChild),n=s.data("slug");s.hasClass("markets-shortlist--shortlisted")?$.ajax({url:u+"?slug="+n,type:"DELETE",success:function(){r(s,o,"Shortlist"),"2"!==sessionStorage.getItem("notify")&&(e("shortlist-notify","Marketplace removed from your shortlist",s),sessionStorage.setItem("notify",2)),i()}}):$.ajax({url:u+"?slug="+n,type:"POST",success:function(){r(s,o,"Shortlisted"),sessionStorage.getItem("notify")||(e("shortlist-notify","Marketplace added to your shortlist",s),sessionStorage.setItem("notify",1)),i()}})}function r(t,s,e){"Shortlisted"===e?(t.addClass("markets-shortlist--shortlisted"),s.addClass("icon-shortlisted")):(t.removeClass("markets-shortlist--shortlisted"),s.removeClass("icon-shortlisted")),t.contents()[0].textContent=e}function i(t){$.ajax({url:u,type:"GET",success:function(s){$(".shortlist-count").html(s.market_slugs.length),void 0!==t&&t(s)}})}function n(t){t.preventDefault(),$.ajax({url:u,type:"DELETE",success:function(){location.reload()}})}var a=$(".markets-shortlist"),l=$(".shortlist-remove"),u="/selling-online-overseas/markets/api/shortlist/";return a.click(o),l.click(n),$(document).ready(t),{init:t}}(jQuery);
